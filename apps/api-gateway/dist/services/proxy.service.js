...
let ProxyService = class ProxyService {
    ...
    async forward(service, method, path, body, query) {
        const baseUrl = this.serviceUrls[service];
        if (!baseUrl) {
            throw new common_1.HttpException(`Service ${service} not found`, 404);
        }
        try {
            ...
            throw new common_1.HttpException(`Service ${service} unavailable`, 503);
        }
    }
};
