...
let VehiclesController = class VehiclesController {
    ...
    findAll(query) { return this.service.findAllVehicles(query); }
    findOne(id) { return this.service.findOneVehicle(id); }
    create(dto) { return this.service.createVehicle(dto); }
    update(id, dto) { return this.service.updateVehicle(id, dto); }
    delete(id) { return this.service.deleteVehicle(id); }
};
